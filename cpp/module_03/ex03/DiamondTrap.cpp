...
DiamondTrap::DiamondTrap() : ClapTrap("Noname_Diamond", frag_hp, scav_energy, frag_attack), ScavTrap(), FragTrap(){
...
DiamondTrap::DiamondTrap(std::string call_me)  : ClapTrap(call_me + "_clap_name" , frag_hp, scav_energy, frag_attack), ScavTrap(), FragTrap(), name(call_me) {
